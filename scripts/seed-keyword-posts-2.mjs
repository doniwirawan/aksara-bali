...
const posts = [
  {
    ...
    image_url: 'https://aksarabali.doniwirawan.xyz/covers/nama-dalam-aksara-bali.png',
    read_time: '6 menit',
    content: `
...
`.trim(),
...

  {
    ...
    image_url: 'https://aksarabali.doniwirawan.xyz/covers/ucapan-bahasa-bali-sehari-hari.png',
    read_time: '6 menit',
    content: `
